...
> extends PlayableContainer<T> {
  ...
  static new_from_playlist_item<Section = unknown>(
    item: PlaylistItem,
    section: Section | null = null,
  ) {
    return new SectionedPlayableContainer({
  ...
  static new_from_mixed_card_item<Section = unknown>(
    item: MixedCardItem,
    section: Section | null = null,
  ) {
    return new SectionedPlayableContainer({
  ...
  static new_from_search_content<Section = unknown>(
    item: SearchContent,
    section: Section | null = null,
  ) {
    return new SectionedPlayableContainer({
